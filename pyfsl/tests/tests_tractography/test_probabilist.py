...
class FslProbtrackx2(unittest.TestCase):
    ...
    'pyfsl.tractography.probabilist.probtrackx2'
    """
    def setUp(self):
        ...
        # Mocking set environ
        self.env_patcher = patch("pyfsl.wrapper.FSLWrapper._fsl_version_check")
    ...
    @mock.patch("pyfsl.tractography.probabilist.os.path.isfile")
    ...
    @mock.patch("pyfsl.tractography.probabilist.os.mkdir")
    @mock.patch("pyfsl.tractography.probabilist.os.path.isdir")
    @mock.patch("pyfsl.tractography.probabilist.os.path.isfile")
    def test_normal_execution(self, mock_isfile, mock_isdir, mock_mkdir):
        ...
        self.assertEqual([
            ...
            mock.call(["probtrackx2",
                       ...
                       "--steplength", self.kwargs["steplength"],
                       "--distthresh", self.kwargs["distthresh"],
                       "--cthr", self.kwargs["cthr"],
                       "--fibthresh", self.kwargs["fibthresh"],
                       "--sampvox", self.kwargs["sampvox"],
                       "--randfib", self.kwargs["randfib"]],
                      env={}, stderr=-1, stdout=-1)],
