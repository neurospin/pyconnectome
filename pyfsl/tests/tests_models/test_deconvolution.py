...
# Pyfsl import
from pyfsl.models.deconvolution import bedpostx
from pyfsl.models.deconvolution import bedpostx_datacheck


class FslBedpostx(unittest.TestCase):
    """ Test the FSL diffusion deconvolution model:
    'pyfsl.models.deconvolution.bedpostx'
    """
    def setUp(self):
    ...
    @mock.patch("pyfsl.models.deconvolution.os.path.isdir")
...
class FslBedpostxDatacheck(unittest.TestCase):
    """ Test the FSL diffusion deconvolution model:
    'pyfsl.models.deconvolution.bedpostx_datacheck'
    """
    def setUp(self):
        """ Run before each test - the mock_popen will be available and in the
        right state in every test<something> function.
